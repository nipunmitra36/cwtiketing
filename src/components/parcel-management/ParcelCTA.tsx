...
const trustPoints: { icon: IconType; title: string; desc: string }[] = [
  {
    ...
    desc: "One tracked record from booking to doorstep",
  },
  {
    icon: HiOutlineOfficeBuilding,
    title: "Multi-Branch Ready",
    desc: "Branches, hubs and agent points under one roof",
  },
  {
    icon: HiOutlineTemplate,
    title: "Branded as Yours",
    desc: "Your portal, your apps, your printed waybills",
  },
  {
    icon: HiOutlineTrendingUp,
    title: "Scales With Volume",
    desc: "From a single counter to a national network",
  },
];

export default function ParcelCTA() {
        ...
        >
          ...
          <div className="relative mx-auto max-w-2xl">
            ...
            <p className="mx-auto mt-3 max-w-xl text-[14px] leading-relaxed text-white/80">
              ...
              we&apos;ll show you the parcel management system configured
              around them.
            </p>
