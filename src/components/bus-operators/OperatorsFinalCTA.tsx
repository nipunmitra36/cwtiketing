...
const trustPoints: { icon: IconType; title: string; desc: string }[] = [
  { icon: HiOutlineGlobeAlt, title: "Trusted Worldwide", desc: "Proven by global intercity operators" },
  { icon: HiOutlineTemplate, title: "White-Label Ready", desc: "Launch custom portals with your branding" },
  { icon: HiOutlineDatabase, title: "You Own the Data", desc: "Full control over routes, pricing, and users" },
  { icon: HiOutlineTrendingUp, title: "Scales With You", desc: "Designed for fleets of any size" },
];

export default function OperatorsFinalCTA() {
        ...
        >
          ...
          <div className="relative mx-auto max-w-2xl">
            <h2 className="text-[24px] font-semibold leading-tight tracking-tight text-white sm:text-3xl">
              Ready to Modernise Your Intercity Bus Operations?
            </h2>
            <p className="mx-auto mt-3 max-w-xl text-[14px] leading-relaxed text-white/80">
              Let&apos;s help you digitise routes, boost sales, and grow your
              brand.
            </p>
