...
const trustPoints: { icon: IconType; title: string; desc: string }[] = [
  {
    ...
    desc: "Admins, operators, agents, counters & passengers in one platform",
  },
  {
    icon: HiOutlineTemplate,
    title: "White-Label Capable",
    desc: "Launch your own branded portals with full flexibility",
  },
  {
    icon: HiOutlineKey,
    title: "You Control Everything",
    desc: "Manage routes, data, and commissions without restrictions",
  },
  {
    icon: HiOutlineTrendingUp,
    title: "Marketplace Ready",
    desc: "Scale with multi-operator tools built for growth",
  },
];
        ...
        >
          ...
          <div className="relative mx-auto max-w-2xl">
            <h2 className="text-[24px] font-semibold leading-tight tracking-tight text-white sm:text-3xl">
              Run a Thriving Bus Marketplace
            </h2>
            <p className="mx-auto mt-3 max-w-xl text-[14px] leading-relaxed text-white/80">
              Digitize operations, onboard operators, and grow your ecosystem
