      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-14 grid gap-6 lg:grid-cols-2 lg:items-end lg:gap-12">
          ...
          <p data-gsap className="max-w-xl text-[14px] leading-relaxed text-text-muted sm:text-[15px] lg:justify-self-end">
            Trusted by bus ticketing marketplaces and networks worldwide —
        ...
        <figure
          data-gsap
          className="relative mx-auto mt-14 max-w-3xl overflow-hidden rounded-[2rem] border border-gray-100 bg-gray-50/60 p-8 shadow-sm sm:p-10"
        >
