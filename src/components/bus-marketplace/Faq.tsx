        ...
        <div className="grid gap-12 lg:grid-cols-[1fr_1.4fr] lg:gap-16">
          ...
          <div data-gsap className="lg:sticky lg:top-28 lg:self-start">
            ...
            <p className="mt-6 max-w-md text-[14px] leading-relaxed text-text-muted sm:text-[15px]">
              Straight answers about onboarding operators, managing
              commissions, and running a bus ticketing marketplace with
              CW Ticketing.
            </p>
            ...
            <div className="mt-8 rounded-2xl border border-gray-200 bg-gray-50/60 p-6 shadow-sm">
              ...
              <p className="mt-1 text-[12.5px] leading-relaxed text-text-muted">
                Talk to our team about launch timelines, commission setup, and
                white-label options for your marketplace.
              </p>
              <Link
                href="/contact"
