...
import TicketFan from "./TicketFan";
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle at 1px 1px, rgba(255,106,28,0.10) 1px, transparent 0)",
          backgroundSize: "34px 34px",
        }}
      />

      <div className="relative mx-auto max-w-7xl px-4 pb-24 sm:px-6 lg:px-8 lg:pb-28">
        <div className="grid items-center gap-16 lg:grid-cols-[1.05fr_0.95fr] lg:gap-12">
          ...
          <div ref={copyRef} className="max-w-2xl">
            ...
            <h1 className="gsap-hero-item mt-5 text-[2rem] font-semibold leading-[1.15] tracking-tight text-text-dark sm:text-[2.6rem] lg:text-[2.75rem] xl:text-[50px]">
              Make Your Events Shine with a{" "}
              <span className="bg-gradient-to-r from-brand via-brand to-brand-dark bg-clip-text text-transparent">
                Smart Online Event Ticketing System
              </span>
            </h1>

            <p className="gsap-hero-item mt-6 max-w-xl text-[15px] leading-relaxed text-text-muted sm:text-[16px]">
              Event ticket management can be a scary affair without the right
              tools. Our event ticketing system removes that stress — flexible
              enough to bend for any type of event, and customizable enough to
            ...
            <div className="gsap-hero-item mt-10 flex flex-col gap-2.5 border-t border-gray-200/80 pt-7 sm:flex-row sm:flex-wrap sm:items-center sm:gap-x-7 sm:gap-y-2">
              {TRUST_ITEMS.map((t) => (
                <span
                  key={t}
                  className="flex items-center gap-2 text-[13.5px] font-medium text-text-body"
                >
