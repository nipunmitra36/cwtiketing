...
const cards: FloatingCard[] = [
  ...
  },
  {
    ...
    subtitle: "Top 5 routes · Dhaka → Sylhet",
...
const checklist = [
  "Every route, seat, and payment in one live view",
...
export default function BusinessIntelligence() {
  ...
  return (
    <section ref={sectionRef} id="business-intelligence" className="relative bg-white">
      <div
        ref={stageRef}
      ...
      >
        <div className="mx-auto mb-10 max-w-xl text-center lg:mb-14">
          ...
          <h2 className="mt-3 text-[22px] font-medium leading-snug tracking-tight text-text-dark sm:text-[28px] sm:leading-snug">
            Every Number Your Operation Needs
          </h2>
          <p className="mt-4 text-[13px] leading-relaxed text-text-muted sm:text-[14px]">
          ...
          <div className="absolute inset-0 flex items-end justify-center">
            <div ref={avatarWrapRef} className="relative h-[380px] w-[380px] sm:h-[460px] sm:w-[460px] lg:h-[min(62vh,580px)] lg:w-[min(62vh,580px)]">
              ...
              <img
                ...
                alt="CW Ticketing operator managing bookings, routes, and revenue"
